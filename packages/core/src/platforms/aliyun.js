...
async function fillAliyunContent(content) {
  ...
  console.log('[FaFaFa-全部发] 阿里云开发者社区：开始填充内容')
  ...
  if (titleInput && title) {
    ...
    console.log('[FaFaFa-全部发] 阿里云开发者社区：标题已填充')
  }
  ...
  if (contentTextarea && markdown) {
    ...
    console.log('[FaFaFa-全部发] 阿里云开发者社区：正文已填充')
  }
  
  console.log('[FaFaFa-全部发] 阿里云开发者社区：内容填充完成')
}
